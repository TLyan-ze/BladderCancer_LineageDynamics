...
HOME = f"{script_dir}/Figure/Figure5_S5/data/"


tumor_list = pd.read_csv(
    f"{script_dir}/tumor_list.txt", sep="\t"
)['Tumor'].values

adata_all = sc.read_h5ad(
    "/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/expression/scRNA4_3000_25.h5ad"
)
