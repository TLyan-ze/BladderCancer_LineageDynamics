...
tumor2modelfp = "/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/allele_new/tumor_list.txt"
...
tumor2model = CSV.read("/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/allele_new/tumor_list.txt", DataFrame, delim='\t')
...
for tumor in tumors
    ...
    fp = string("/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/allele_new/fitnesses/mean_fitness.", tumor, ".txt");
    if !isfile(fp)
        continue;
    end 

    println(string("Analyzing tumor ", tumor))
    fitness = CSV.read(string("/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/allele_new/fitnesses/mean_fitness.", tumor, ".txt"), DataFrame, delim='\t');
    ...
    CSV.write(open(string("/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/fitnesses/fitness_log2fc.", tumor, ".txt"), "w"), res_df, delim = "\t");
    println("1")
end
