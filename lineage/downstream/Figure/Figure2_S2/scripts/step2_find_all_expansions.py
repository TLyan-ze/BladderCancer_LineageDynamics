...
sys.path.append("/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/allele_new/Figure/Figure2_S2/")
...
save_dir = "/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/allele_new/expansions"
tumor_list = pd.read_csv(f"{data_directory}/tumor_list.txt2", sep='\t')
