...
HOME = '/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/plot/Figure5_S5/data/'


tumor_list = pd.read_csv(
    "/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/allele/tumor_list.txt", sep="\t"
)['Tumor'].values

adata_all = sc.read_h5ad(
    "/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/expression/scRNA4.h5ad"
)
...
for tumor in tqdm(tumors):
    ...
    graph = tree_utilities.prepare_tumor_tree(
        ...
        tree_dir = "/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/allele/trees",
    ...
    leaf_states = adata_all.obs.loc[_leaves, "leiden_sub"]
