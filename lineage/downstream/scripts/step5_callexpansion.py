...
sys.path.append("/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/plot/Figure2_S2/")
...
data_directory = "/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/allele"
base_dir = f"{data_directory}/trees/"
save_dir = "/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/expansions"
...
character_matrix = pd.read_csv(f"{data_directory}/trees/{tumor}_character_matrix.txt", sep='\t', index_col = 0)
print(tumor)
...
outfp = os.path.join(save_dir, f"clonal_expansions.{tumor}.txt")
