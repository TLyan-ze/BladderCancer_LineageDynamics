...
adata = sc.read_h5ad(f'/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/expression/MGH.h5ad')
...
allele_table_unfiltered = pd.read_csv(f"/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/allele_MGH/01_metainfo/AP.alleleTable.unfiltered.txt2", sep='\t')
...
plt.savefig('/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/expression/plot_MGH/01-qc_violin1.png')
...
sc.pl.umap(adata, color="sample",legend_loc="on data",legend_fontsize="small")
plt.savefig('/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/expression/plot_MGH/03-clsters_violin1.png')
sc.pl.umap(adata, color='leiden_sub',legend_loc="on data",legend_fontsize="small")
plt.savefig('/WorkDir4/yanzeqin/220823_A00403_0863_AHMNGLDSX3/Script/AP-data/expression/plot_MGH/03-clsters_violin2.png')
adata.var_names_make_unique()
adata.obs_names_make_unique()
adata.write('scRNA4_2000_MGH.h5ad')
